...
const MESSAGES = {
  en: {
    ...
    checkout: {
      ...
      city: 'City',
      chooseCity: 'Choose delivery city / area',
      searchCity: 'Search city or area…',
      cityNoResults: 'No cities match that search',
      deliveryHint: 'Delivery price updates when you choose a city.',
      deliveryUnavailable: 'Delivery cities unavailable — ask the store',
      zoneInside: 'Inside Benghazi',
      zoneOutside: 'Outside Benghazi',
      clearCity: 'Clear city',
      errorCity: 'Please choose a delivery city',
  ...
  ar: {
    ...
    checkout: {
      ...
      city: 'المدينة',
      chooseCity: 'اختر مدينة / منطقة التوصيل',
      searchCity: 'ابحث عن مدينة أو منطقة…',
      cityNoResults: 'لا توجد مدن مطابقة',
      deliveryHint: 'سعر التوصيل يتغير تلقائياً عند اختيار المدينة.',
      deliveryUnavailable: 'مدن التوصيل غير متاحة حالياً',
      zoneInside: 'داخل بنغازي',
      zoneOutside: 'خارج بنغازي',
      clearCity: 'مسح المدينة',
      errorCity: 'يرجى اختيار مدينة التوصيل',
      payment: 'طريقة الدفع',
      cad: 'CAD',
